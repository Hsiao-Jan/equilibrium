...
import (
	...
	"github.com/kowala-tech/equilibrium/console"
	"github.com/spf13/cobra"
)

const consoleDesc = `A longer description that spans multiple lines and likely contains examples
...
func runConsole(cmd *cobra.Command, args []string) {
	...
	console, err := console.New(&console.Config{})
	defer console.Close()
}
