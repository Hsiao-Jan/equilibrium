...
func TestTypeRegexp(t *testing.T) {
	tests := []struct {
		...
		{"address[]", Type{T: SliceTy, Kind: reflect.Slice, Type: reflect.TypeOf([]types.Address{}), Elem: &Type{Kind: reflect.Array, Type: addressT, Size: 20, T: AddressTy, stringKind: "address"}, stringKind: "address[]"}},
		{"address[2]", Type{Kind: reflect.Array, T: ArrayTy, Size: 2, Type: reflect.TypeOf([2]types.Address{}), Elem: &Type{Kind: reflect.Array, Type: addressT, Size: 20, T: AddressTy, stringKind: "address"}, stringKind: "address[2]"}},
...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"address[1]", []types.Address{{1}}, ""},
		{"address[1]", [1]types.Address{{1}}, ""},
		{"address[2]", [1]types.Address{{1}}, "abi: cannot use [1]array as type [2]array as argument"},
		{"bytes32", [32]byte{}, ""},
		{"bytes31", [31]byte{}, ""},
		{"bytes30", [30]byte{}, ""},
		{"bytes29", [29]byte{}, ""},
		...
		{"bytes32", types.Hash{1}, ""},
		{"bytes31", types.Hash{1}, "abi: cannot use types.Hash as type [31]uint8 as argument"},
		{"bytes31", [32]byte{}, "abi: cannot use [32]uint8 as type [31]uint8 as argument"},
		{"bytes", []byte{0, 1}, ""},
		{"bytes", [2]byte{0, 1}, "abi: cannot use array as type slice as argument"},
		{"bytes", types.Hash{1}, "abi: cannot use array as type slice as argument"},
		{"string", "hello world", ""},
		{"string", string(""), ""},
