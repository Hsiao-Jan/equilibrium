...
type Generator struct {
	blooms   [common.BloomBitLength][]byte // Rotated blooms for per-bit matching
...
func (b *Generator) AddBloom(index uint, bloom common.Bloom) error {
	...
	for i := 0; i < common.BloomBitLength; i++ {
		bloomByteIndex := common.BloomByteLength - 1 - i/8
